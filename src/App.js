...
class App extends Component {
  ...
  render() {
    ...
    const isVisitedCountriesList = visitedCountriesList.length === 0
          ...
          <ul className="countries-list-container">
            {countriesList.map(eachCountry => (
              <CountryItem
                ...
                onToggleVisitStatus={this.onToggleVisitStatus}
              />
            ))}
          </ul>
          <h1 className="page-heading">Visited Countries</h1>
          {isVisitedCountriesList ? (
            <div className="no-countries-container">
              <p className="no-countries-found-text">
